<template>
  <div class="space-y-6">
    ...
    <p class="text-gray-900 dark:text-gray-400">
      ...
      Malaysia. I specialize in building web applications and sites
    ...
    <p class="text-gray-900 dark:text-gray-400">
      ...
      <a href="https://www.tapgoing.com/" target="_blank" class="underline">Tap Go</a>, and
...
useSeoMeta({
  title: "Thomas Gwee",
  description:
    "I'm Thomas, your friendly neighborhood software, product engineer and designer from Malaysia. I specialize in building web applications and sites using Javascript, React, Vue & Node.",
});
</script>
